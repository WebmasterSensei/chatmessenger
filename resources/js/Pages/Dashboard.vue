<template>
    <AuthenticatedLayout>
        <div class="flex flex-col md:flex-row h-screen bg-gray-100">
            ...
            <div class="w-full md:w-1/5 border-r border-gray-300 bg-white transition-all duration-300 ease-in-out"
                :class="{
                    'hidden md:block': activeChat && !showChatList,
                    'block': !activeChat || showChatList,
                    'absolute inset-0 z-10 md:relative': activeChat
                }">
                <ChatList ref="chatListRef"  @select-chat="handleSelectChat" :online-user="getOnlineUsers" />
            </div>
            ...
            <div class="flex-1 bg-white" :class="{
                ...
                <ChatWindow @fetch-users="handleFetchUser" v-if="activeChat" :chat="activeChat" @back="showChatList = true" />
            ...
            <div class="w-full md:w-1/5 border-l border-gray-300 bg-white transition-all duration-300 ease-in-out"
                :class="{
                    'hidden md:block': activeChat && !showChatList,
                    'block': !activeChat || showChatList,
                }">
